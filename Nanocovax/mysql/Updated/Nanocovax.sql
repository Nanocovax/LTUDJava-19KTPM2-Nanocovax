...
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
ALTER TABLE ttnguoidung ADD CONSTRAINT check_trangthai CHECK (trangthai IN ('F0', 'F1', 'F2','F3','F4','F5','BT'));
...
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
ALTER TABLE hoadon ADD CONSTRAINT check_tratruoc CHECK (tratruoc>=0 and tratruoc<=tongtien);
...
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
ALTER TABLE cthd ADD CONSTRAINT check_soluong CHECK (soluong >= 0);
...
ADD CONSTRAINT check_tinhtrang CHECK (tinhtrang IN ('khoa', 'bt', 'ckh'));
...
-- select phanquyen from TAIKHOAN where id = "admin" and password = "admin";
-- insert into TAIKHOAN values('admin', 'admin', 'admin', 'bt');
